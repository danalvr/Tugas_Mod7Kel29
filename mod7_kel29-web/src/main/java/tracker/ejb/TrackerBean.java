...
public class TrackerBean implements TrackerBeanLocal {
    ...
    private int count = 0;
    private final List<Double> oddValuesList = new ArrayList<>();
    private final List<Double> evenValuesList = new ArrayList<>();
    ...
    private double[] convertListToArray(List<Double> valuesList) {
