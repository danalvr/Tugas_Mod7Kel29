...
public class Tracker extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            double[] oddValues = trackerBean.getOddValues();
            out.println("Odd Values: ");
            for (double oddValue : oddValues) {
                out.println(oddValue + " ");
            }
            out.println("<br />");

            // Menampilkan nilai genap
            double[] evenValues = trackerBean.getEvenValues();
            out.println("Even Values: ");
            for (double evenValue : evenValues) {
                out.println(evenValue + " ");
            }
